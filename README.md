...
This is an independent learning project and is not affiliated with, endorsed by, or sponsored by Cambridge University Press & Assessment or Cambridge English. All CEFR proficiency levels (such as C1 and C2) referenced throughout this application denote standards under the Common European Framework of Reference for Languages. Evaluative scores, bands, and feedback generated by this application are for practice and educational self-assessment purposes only and do not constitute official examination results or certificates.
