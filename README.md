# Cambridge C1+ Writing & Speaking Academy
...
### 2. Writing Studio & Real-time C1 Syntax Radar
- **220–260 Word Meter**: Adheres strictly to Cambridge C1 Part 1 essay target word counts.
- **Dynamic Vocabulary Tracker**: Automatically detects required vocabulary as you write, turning chips into green "✓ USED" badges.
- **Syntax Radar**: Live detector for advanced Cambridge grammatical structures:
...
### 3. Cambridge 4-Scale Assessment Engine (The C1 Gatekeeper)
- Evaluates submissions across the 4 official Cambridge Assessment scales (each scored 0–5, total /20):
  - **Content**: Word count compliance, thorough development of both prompt points.
  - **Communicative Achievement**: Academic formal register, absence of colloquialisms or contractions.
...
- **The Gatekeeper**: Achieving **C1 (Band 4)** or **C2 (Band 5)** grants entry to the Speaking & Pronunciation phase. Sub-C1 submissions receive detailed examiner recommendations.

### 4. Speaking & Pronunciation Studio
- **Teleprompter**: Formats your written essay for aloud reading.
...
- **Live Microphone Speech Recognition**: Real-time phonetic and word-by-word alignment using the Web Speech API:
  ...
  - 🟡 **Amber**: Accent slurs or minor phonetic deviations.
...
- **Cambridge Speaking Report**: Detailed metrics for Pronunciation Accuracy (%), Cadence (WPM against 130–160 Cambridge target), and Cambridge Speaking Band.
...
- **Frontend**: Vanilla HTML5, modern CSS3 (Oxford glassmorphism design system), Vanilla JavaScript (ES6+).
...
MIT License. Developed for Cambridge C1 & C2 English candidates.
